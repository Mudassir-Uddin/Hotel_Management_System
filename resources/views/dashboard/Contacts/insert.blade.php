        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Horizontal Form -->
              <form action="{{ url('/ContactsStore') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="floatingText">Contact name</label>
                    @error('name')
                ...
                <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="floatingText" value="{{ old('email') }}"  
                ...
                <div class="form-floating mb-3">
                  <input type="number" class="form-control" id="floatingText" value="{{ old('phone') }}"  
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingText" value="{{ old('message') }}"  
