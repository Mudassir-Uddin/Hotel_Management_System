                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="index.html"><img src="{{url('/Website/images/logo.png')}}" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-md-10 offset-md-1">
                        ...
                        <p>
                        © 2019 All Rights Reserved. Design by <a href="https://www.youtube.com/@CodeRunnerSolution"> Code Runner</a>
                        <br><br>
