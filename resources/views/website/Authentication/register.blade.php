                ...
                <div class="col-12 col-sm-10 col-md-7 col-lg-7 col-xl-7">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="{{ url('/registerstore') }}" method="POST" enctype="multipart/form-data" id="loginForm">
                            ...
                            <button type="submit" style="background-color:#3c76cc; border-color:#3c76cc;" class="btn btn-primary py-3 w-100 mb-4 fs-5">Register</button>
                            <a href="{{url('/login')}}"  style="color:#3c76cc;">Already have an account? Login :)</a>
                        </form>
                    </div>
                </div>
            </div>
